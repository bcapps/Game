...
class ItemCodingTests: XCTestCase {
    ...
    func testItemReceivesLatestCopy() {
        let item = Item(name: "Basic Hammer", damage: "Damage", effects: "Effects", flavor: "Flavor", itemSlot: ItemSlot.Helmet, twoHanded: true, statEffects: [], resistanceEffects: [], avoidanceModifier: 0, attackModifier: 0)
